...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Формы
  const modals = {
    add: document.getElementById('clientsApplicationsStatusesAddForm'),
    change: document.getElementById('clientsApplicationsStatusesChangeForm'),
    delete: document.getElementById('clientsApplicationsStatusesDeleteForm'),
    error: document.getElementById('clientsApplicationsStatusesErrorModal'),
    success: document.getElementById('clientsApplicationsStatusesSuccessModal')
  };
  ...
  const buttons = {
    ...
    addSubmit: document.querySelector('#clientsApplicationsStatusesAddForm button[type="submit"]'),
    changeSubmit: document.querySelector('#clientsApplicationsStatusesChangeForm button[type="submit"]'),
  ...
  const table = {
    ...
    body: document.getElementById('application-statuses-table-body'),
    ...
    deleteInfo: {
      name: document.getElementById('deleteStatusName'),
    },
  ...
  buttons.changeSubmit.addEventListener('click', async (e) => {
    ...
    try {
      const response = await fetch(`/api/application-statuses/${selectedApplication.id}/`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': getCsrfToken()
