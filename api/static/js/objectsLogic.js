...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Формы
  const modals = {
    add: document.getElementById('objectsAddForm'),
    change: document.getElementById('objectsChangeForm'),
    delete: document.getElementById('objectsDeleteForm'),
    error: document.getElementById('objectsErrorModal'),
    success: document.getElementById('objectsSuccessModal')
  };
  ...
  const buttons = {
    ...
    addSubmit: document.querySelector('#objectsAddForm button[type="submit"]'),
    changeSubmit: document.querySelector('#objectsChangeForm button[type="submit"]'),
  ...
  const table = {
    ...
    body: document.getElementById('objects-table-body'),
    ...
    deleteInfo: {
      name: document.getElementById('deleteObjName'),
      address: document.getElementById('deleteObjAddress'),
    },
  ...
  table.body.addEventListener('click', (event) => {
    ...
    document.querySelectorAll('#objects-table-body tr').forEach(r => 
  ...
  buttons.addSubmit.addEventListener('click', async (e) => {
    ...
    const data = {
      ...
      address: table.addFields.address.value.trim(),
  ...
  buttons.delete.addEventListener('click', () => {
    ...
    table.deleteInfo.address.textContent = selectedApplication.address;
  ...
  buttons.changeSubmit.addEventListener('click', async (e) => {
    ...
    try {
      const response = await fetch(`/api/objects/${selectedApplication.id}/`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': getCsrfToken()
